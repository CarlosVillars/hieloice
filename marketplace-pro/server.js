...
const NOTIF_CATEGORIES = ["offers", "flashSales", "newProducts", "reminders"];
...
async function handleApi(req, res, pathname, query) {
  ...
  if (method === "POST" && convoMatch) {
    ...
    notifyUser(otherId, "offers", {
      title: "Nuevo mensaje en HieloIce",
      body: (me.name || "Alguien") + " te envió un mensaje",
      url: "/#/messages/" + me.id,
    }).catch(() => {});
    return sendJson(res, 201, {
      id: message.id,
